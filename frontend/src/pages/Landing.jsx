                ...
                <div className="relative z-10 container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <motion.div
                            ...
                            className="inline-block px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white/90 text-sm font-bold tracking-widest uppercase mb-8"
                        >
                        ...
                        <motion.h1
                            ...
                            className="text-5xl md:text-7xl font-extrabold mb-8 text-white leading-[1.1] tracking-tight"
                        >
                            ADVENTURE <br />
                        ...
                        <motion.p
                            ...
                            className="text-xl md:text-3xl mb-12 text-blue-50 font-medium leading-relaxed drop-shadow-md"
                        >
                    ...
                    >
                        <Link to="/explore">
                            <motion.button
                                ...
                                className="px-10 py-5 bg-blue-600 text-white rounded-[2rem] font-black text-lg shadow-xl shadow-blue-500/25 inline-flex items-center gap-3 transition-all hover:bg-blue-700 hover:shadow-2xl hover:shadow-blue-500/40 group rtl:flex-row-reverse"
                            >
                                <span>Explore All Destinations</span>
                                <FiArrowRight className="transition-transform group-hover:translate-x-1" size={24} />
                            </motion.button>
                        </Link>
                    </motion.div>
                </div>
                    ...
                    >
                        ...
                        <Link to="/booking">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="bg-white text-blue-600 px-10 py-5 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl transition-all"
                            >
                                Book your Journey
                            </motion.button>
                        </Link>
