...
const Explore = () => {
    ...
    return (
        <div className="min-h-screen pt-20 md:pt-28 pb-12 md:pb-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            <div className="container-custom">
                ...
                >
                    <div className="flex flex-col gap-4 md:gap-6">
                        <div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold text-slate-900 dark:text-white mb-3 md:mb-4">
                        ...
                        <div className="flex items-center justify-between gap-3 md:gap-4">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 md:py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium text-sm md:text-base shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5 ml-auto"
                            >
                                <FiSliders size={18} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-8 items-start relative">
                            ...
                            <>
                                ...
                                <motion.div
                                    ...
                                    className={`
                                        ...
                                        w-[85%] sm:w-96 lg:w-auto
                                        lg:block
                                        z-50 lg:z-auto
                                        overflow-y-auto lg:overflow-visible
                                    `}
                                >
                                    <div className="bg-white dark:bg-slate-900 p-4 md:p-6 rounded-none lg:rounded-3xl h-full lg:h-auto lg:sticky lg:top-28 border-r lg:border border-slate-200/50 dark:border-slate-800/50 shadow-xl backdrop-blur-xl">
                                        <div className="flex items-center justify-between mb-6">
                                            <h3 className="text-lg md:text-xl font-bold flex items-center gap-2 text-slate-800 dark:text-white">
                                            ...
                                            <div className="flex items-center gap-2">
                                                {Object.values(filters).some(v => v) && (
                                                    <button
                                                        ...
                                                        className="text-xs md:text-sm font-semibold text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-2 md:px-3 py-1.5 rounded-lg transition-all flex items-center gap-1"
                                                    >
                                                        <FiX size={14} /> Reset
                                                    </button>
                                                )}
                                        ...
                                        <div className="space-y-5 md:space-y-6">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500/30 outline-none transition-all text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 text-sm md:text-base"
                                                />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl outline-none text-slate-800 dark:text-white appearance-none cursor-pointer text-sm md:text-base"
                                                    >
